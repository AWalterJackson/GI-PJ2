...
namespace PirateGame
{
    ...
    public class MyModel
    {
        ...
        public MyModel(PirateGame game, VertexPositionColor[] shapeArray, String textureName, float collisionRadius)
        {
        ...
        public MyModel(PirateGame game, VertexPositionTexture[] shapeArray, String textureName, float collisionRadius)
        {
            this.vertices = Buffer.Vertex.New(game.GraphicsDevice, shapeArray);
